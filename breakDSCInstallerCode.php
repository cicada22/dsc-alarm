...
// Script parameters
$address            = '1.2.3.4'; // IP address of Envisalink module
$port 	            = 4025;
$password           = "user";         // Password to Envisalink (the same as to login to Envisalink module webserver, factory default - user)
$startingCode       = 40;              // Codes are checked with brute force starting from this value till 9999 - useful if you restart the script
